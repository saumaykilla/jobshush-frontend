...
const WorkExperience = () => {
  ...
  return (
    <div className="space-y-6 text-xs">
      <div id="workExperience-entries" className="space-y-4">
        <Accordion
          type="single"
          collapsible
                ...
                return (
                  <DraggableItem key={lineItem?.id} id={lineItem?.id}>
                    <AccordionItem
                      value={`${lineItem}.${idx}`}
                      className={` ${
                        errors?.workExperience?.lineItem?.[idx]?.company ||
                        errors?.workExperience?.lineItem?.[idx]?.role ||
                        errors?.workExperience?.lineItem?.[idx]?.location ||
                        errors?.workExperience?.lineItem?.[idx]?.endDate ||
                        errors?.workExperience?.lineItem?.[idx]?.startDate
                          ? "border-red-300 "
                          : "border-gray-200 "
                      ...
                      <AccordionTrigger className="text-xs  p-4 flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          <span className="font-medium">
                            {watchedWorkExperience?.lineItem?.[idx]?.company
                              ? watchedWorkExperience?.lineItem?.[idx]?.company
                              : `Experience ${idx + 1}`}
                          </span>
                        </div>
                        ...
                        <div className="grid gap-4">
                          ...
                          <div  className="flex items-center justify-between">
                            ...
                            <Input
                              ...
                              {...register(`workExperience.lineItem.${idx}.role`)}
                            />
                          </div>
                                ...
                                render={({
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => {
                                      ...
                                      methods?.trigger(`workExperience.lineItem.${idx}.startDate`); // re-validate dependent field
                                      methods?.trigger(`workExperience.lineItem.${idx}.endDate`);
                                    }}
                          ...
                          <div className="grid gap-2">
                            ...
                            <div>
                              <Editor
                                ...
                                content={
                                  watchedWorkExperience?.lineItem?.[idx]
                                    ?.description
                                }
