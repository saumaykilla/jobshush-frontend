...
export default function AuthCallback() {
  ...
  const handleAuthCallback = async () => {
    try {
      ...
      } else if (attributes['custom:isOnboarded'] === 'false') {
  ...
  return (<div className="min-h-screen bg-background text-foreground flex items-center justify-center">
    <div className="text-center space-y-6">
      ...
      >
        <h2 className="text-2xl mb-2">Excelify</h2>
        <p className="text-muted-foreground">Loading your AI-powered career platform...</p>
      </motion.div>
